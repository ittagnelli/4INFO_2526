...
function cerca() {
    ...
    for(let i = 2; 1 < linee.length;  i++) {
        ...
        if(tdcognome == cognomeForm || tdtelefono == telefonoForm) {
            console.log("linea trovata: ", linee[1].id)
            ...
            cognome.value =  linee[i].children[0].innerText;
            nome.value =  linee[i].children[1].innerText;
            indirizzo.value =  linee[i].children[2].innerText;
            telefono.value =  linee[i].children[3].innerText;
            return;
