console.log("Inizio Carrello JS");
...
function aggiungiProdotto() {
    let prodotto = document.getElementById('prodoo');
    ...
    if (nome_prodotto == "" || isNaN(quantita_aggiunta) || quantita_aggiunta < 1 || isNaN(costo_unitario) || costo_unitario <= 0) {
        alert("Inserisci tutti i campi correttamente: nome, quantità (min. 1) e costo (maggiore di 0).");
        return;
    }
...
w    contenitore_dati = document.getElementById('contenitore-dati');
